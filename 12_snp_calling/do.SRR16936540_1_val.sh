...
#Place your command lines below this
	...
	rm SRR16936540_1_val.versus.Xe173.fasta.aln.sam

	rm SRR16936540_1_val.versus.Xe173.fasta.aln.bam

	rm SRR16936540_1_val.versus.Xe173.fasta.aln.bam.sorted.bam
