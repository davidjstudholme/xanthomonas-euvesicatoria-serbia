...
#Place your command lines below this
	...
	rm SRR24958750_1_val.versus.Xe173.fasta.aln.sam

	rm SRR24958750_1_val.versus.Xe173.fasta.aln.bam

	rm SRR24958750_1_val.versus.Xe173.fasta.aln.bam.sorted.bam
